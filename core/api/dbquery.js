...
module.exports = function (system) {
	...
	this.post('/', bodyParser.json({ limit: '5mb' }), function (req, res) {
		...
		system.checkAccess(req.ntlm.UserName, system.tree.objects.admin._id('SQL Запрос'))
		// system.checkAccess(req.ntlm.UserName, system.tree.objects.admin['SQL Запрос']) хотелось бы но нет!
