...
на базе самых современных веб-технологий
 ...
 ###  WHY Node.js? 
 Система построена целиком и полностью на Node.js, потому что на
 ...
 готовых модулей почти на все случаи жизни. Помимо Node.js как собственно, ядра
 системы, задействованы такие "модные" штуки, как Express, Webpack, Vue.js, Vuetify
